    ...
    <section className="min-h-screen bg-gradient-to-br from-[#fff9ec] via-[#f0fdfa] to-[#ecfdf5] 
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className={`flex flex-col sm:flex-row gap-4 justify-center items-center transform transition-all duration-1000 delay-800 ${
          ...
          <button className="group bg-[#14B8A6] hover:bg-[#0D9488] text-white px-8 py-4 rounded-full 
                           font-medium text-lg transition-all duration-300 transform hover:scale-105 
                           hover:shadow-lg hover:shadow-[#14B8A6]/25 flex items-center gap-2">
            Voir auto-a11y
          ...
          <button className="group border-2 border-[#F59E0B] text-[#F59E0B] hover:bg-[#F59E0B] hover:text-white 
